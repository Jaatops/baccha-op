...
from Indorix import Telegram, YouTube, app
from Indorix.misc import SUDOERS, _boot_
from Indorix.plugins.playlist import del_plist_msg
from Indorix.plugins.sudoers import sudoers_list
from Indorix.utils.database import (add_served_chat,
                                       add_served_user,
                                       get_served_chats,
                                       get_served_users,
                                       blacklisted_chats,
...
from Indorix.utils.decorators.language import LanguageStart
from Indorix.utils.formatters import get_readable_time
from Indorix.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgUAAx0CaEuO5AACCedkQZuO7z5AnXwcuDdZJXTaiuOAZgACQgkAAnswiVTvrdBbkJpnyi8E")
